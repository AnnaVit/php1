...
$menu = [
    ...
    'Контакты',
    'Доставка' ,
    'Личный кабинет' => ['Все заказы', 'Что-то ещё', 'Что-то ещё']
];

echo "<ul id='menu'>";
foreach( $menu as $menuKey => $valueKey) {
    

    if(is_array($valueKey)){

        echo "<li id='lk_list'>{$menuKey}";
        echo "<ul id='submenu'>";

        foreach( $valueKey as $key => $value){            
            echo "<li class='sublist'>$value</li>";            
        }
